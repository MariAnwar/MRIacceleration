...
class NonCartesianScampi(UcnnReco):
    ...
    def prep_data(self):
        ...
        # Case 2: image is given, kspace and ktraj are generated
            ...
            self.dim = self.gt.shape  # (C, H, W) format, set after self.gt is defined
        ...
        self.x = torch.rand((self.input_dim, self.input_shape[0], self.input_shape[1])) \
             .to(device=self.device).unsqueeze(0).to(self.dtype)
